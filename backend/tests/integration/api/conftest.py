...
does NOT auto-discover it as a conftest at the parent level). API-level
integration tests opt in by importing those fixtures through this
directory-local ``conftest.py``.
"""
