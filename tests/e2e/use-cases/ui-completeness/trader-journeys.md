...
| TJ-4  | Deploy a paper portfolio                                | **DEFERRED**                                         | yes    | `/live-trading/portfolio` route **HARD-DISABLED** (returns 404) per council verdict 2026-05-17 — see `docs/decisions/2026-05-17-portfolio-backtest-deferred.md`. The JSON-Config / fixed-weight UX did not meet the industry-standard bar (multi-select + allocation-method picker + portfolio-level backtest). Redesign queued for dedicated `/new-feature portfolio-backtest` PR. |
